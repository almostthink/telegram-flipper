        ...
        <div className="flex items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-xs leading-relaxed text-neutral-500">
              ...
              <br />
              На живых деньгах движок подчиняется тем же предохранителям, что и
              покупка: нужен включённый автомат, коллекция из whitelist и запас на
              балансе. Заявка резервирует деньги сразу, поэтому обходного пути мимо
              этих проверок здесь нет — снятие заявки при этом не блокируется никогда.
            </p>
          </div>
          <Button
